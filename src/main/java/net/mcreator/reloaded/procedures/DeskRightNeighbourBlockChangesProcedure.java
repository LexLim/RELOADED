...
public class DeskRightNeighbourBlockChangesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if (!((world.getBlockState(new BlockPos(x + 1, y, z))).getBlock() == ReloadedModBlocks.DESK_MIDDLE.get())) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
					BlockState _bs = ReloadedModBlocks.DESK.get().defaultBlockState();
			...
			if (!((world.getBlockState(new BlockPos(x, y, z - 1))).getBlock() == ReloadedModBlocks.DESK_MIDDLE.get())) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
					BlockState _bs = ReloadedModBlocks.DESK.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);

...
public class ReloadedMod {
	public static final Logger LOGGER = LogManager.getLogger(ReloadedMod.class);
	public static final String MODID = "reloaded";

	public ReloadedMod() {
		MinecraftForge.EVENT_BUS.register(this);
		ReloadedModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		ReloadedModBlocks.REGISTRY.register(bus);

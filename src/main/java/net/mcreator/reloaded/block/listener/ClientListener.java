...
import net.mcreator.reloaded.block.renderer.ElevatorTileRenderer;
...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(ReloadedModBlockEntities.ELEVATOR.get(), ElevatorTileRenderer::new);
	}
}

package net.mcreator.reloaded.block.entity;
...
public class SlidingDoor2AnimCloseTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SlidingDoor2AnimCloseTileEntity(BlockPos pos, BlockState state) {
		super(ReloadedModBlockEntities.SLIDING_DOOR_2_ANIM_CLOSE.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<SlidingDoor2AnimCloseTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<SlidingDoor2AnimCloseTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("sliding_door_2_anim_close");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Sliding Door 2 Anim");
	}
